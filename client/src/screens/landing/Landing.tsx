...
import { ArrowRight, Check, Zap, Shield, Users, Clock, Star, ChevronDown, Upload, Palette, Sparkles, Download, Brush, Camera, Quote } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="flex items-center gap-8">
              ...
              <a href="https://github.com/Koushith/DefinVoice" target="_blank" rel="noopener noreferrer" className="text-base font-medium text-gray-600 hover:text-gray-900 transition-colors">GitHub</a>
            </nav>
          </div>
        </div>
      </header>
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div className="space-y-8">
                  ...
                  <p className="text-lg sm:text-xl font-medium text-gray-600 leading-relaxed">
                    Open source invoicing for <span className="font-bold text-gray-900">freelancers</span> and <span className="font-bold text-gray-900">businesses</span>. Self-host for complete control or use our hosted version. Your data, your way.
                  </p>
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-base font-medium text-gray-700">12 beautiful templates & automated reminders</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="w-5 h-5 rounded-full bg-[#635BFF] flex items-center justify-center flex-shrink-0">
                        <Check className="w-3 h-3 text-white" />
                      </div>
                      <span className="text-base font-medium text-gray-700">Public hosted invoices with shareable links</span>
                    </div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl font-medium text-gray-600 max-w-2xl mx-auto">
              Open source invoicing made simple. Self-host for full control or use our hosted version. Your data stays yours.
            </p>
          </div>
      ...
      <section id="how-it-works" className="py-24 bg-gradient-to-b from-blue-50 to-white relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">Create professional invoices in 4 simple steps. No experience required.</p>
          </div>
            ...
            {[
              ...
              <div key={idx} className="group">
                <div className="relative bg-gradient-to-br from-gray-50 to-white p-6 rounded-2xl border border-gray-200 hover:border-gray-300 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                  ...
                  <div className="absolute -bottom-2 -right-2 px-3 py-1 bg-[#635BFF] text-white text-xs font-bold rounded-full transform rotate-3">{testimonial.badge}</div>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-20 bg-[#635BFF]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-10">
            Transform your invoicing in minutes, not hours
          </p>
          <button
            onClick={() => navigate('/login')}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="grid grid-cols-2 gap-8">
              <div>
                ...
                <ul className="space-y-3">
                  ...
                  <li><a href="https://github.com/Koushith/DefinVoice#readme" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-900 transition-colors">Documentation</a></li>
                  <li><a href="/reports" className="text-gray-600 hover:text-gray-900 transition-colors">Get Started</a></li>
                </ul>
              </div>
              <div>
                <h4 className="text-sm font-bold uppercase tracking-wider text-gray-500 mb-4">Community</h4>
                <ul className="space-y-3">
                  <li><a href="https://github.com/Koushith/DefinVoice" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-900 transition-colors">GitHub</a></li>
                  <li><a href="https://github.com/Koushith/DefinVoice/issues" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-900 transition-colors">Report Issue</a></li>
                  <li><a href="https://github.com/Koushith/DefinVoice/blob/main/CONTRIBUTING.md" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-900 transition-colors">Contribute</a></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-600 text-sm">
              © 2025 DefInvoice. Open source under MIT License.
            </p>
            <a
